...
<head>
    ...
    <!--title  -->
    <title>Rara PetShop | Profile</title>
                                                ...
                                                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="account-inner-form">
                                                        <div class="review-form-name">
                                                            ...
                                                            <input type="email" id="gmail" class="form-control" name="email" placeholder="Email Anda" value="{{ Auth::user()->email }}" required>
                                                        </div>
                                                        <div class="review-form-name">
                                                            <label for="telephone" class="form-label">Telepon*</label>
                                                            <input type="tel" id="telephone" class="form-control" placeholder="+880388**0899" name="telepon" value="{{ Auth::user()->telepon }}" required>
                                                        </div>
                                                    </div>

                                                    <div class="review-form-name address-form">
                                                        <label for="address" class="form-label">Alamat*</label>
                                                        <textarea id="address" class="form-control" rows="4" name="alamat" placeholder="Masukkan alamat lengkap Anda" required>{{ Auth::user()->alamat }}</textarea>
                                                    </div>
                                        ...
                                        <div class="img-upload-section">
                                            <div class="logo-wrapper">
                                                ...
                                                <div class="logo-upload">
                                                    <img src="{{ asset('frontend/assets/images/homepage-one/sallers-cover.png') }}"
