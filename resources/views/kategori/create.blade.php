        ...
        <div class="col-12 col-lg-12">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div class="row mb-3">
                        <label for="input40" class="col-sm-3 col-form-label">Deskripsi</label>
                        <div class="col-sm-9">
                            <textarea class="form-control" id="input40" name="deskripsi" rows="3" placeholder="deskripsi"></textarea>
